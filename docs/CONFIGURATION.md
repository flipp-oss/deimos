...
| fill_primary_key         | true              | Whether to fill the primary key of saved batch records. Useful in scenarios when consumed messages already includes the primary key                                                                                                                                                                                                                                                                                        |
