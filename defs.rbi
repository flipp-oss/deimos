...
'in future releases. Please use kafka_producers instead.', T.untyped)
  ...
  module Utils
    ...
    module SchemaClass
      ...
      # 
      # _@param_ `namespace`
      sig { params(schema: String, namespace: String).returns(String) }
      def self.schema_constant(schema, namespace = ''); end
  ...
  module SchemaBackends
    ...
    class AvroBase < Deimos::SchemaBackends::Base
      ...
      sig { params(avro_schema: Avro::Schema::NamedSchema, path: String).returns(String) }
      def self.sorbet_type(avro_schema, path); end
...
module Tapioca
  module Compilers
    class Deimos < Tapioca::Dsl::Compiler
      extend T::Sig
      ConstantType = T.let(type_member {{ fixed: T.class_of(::Deimos::SchemaClass::Record) }}, T.untyped)

      class << self
        # sord omit - no YARD type given for :schemas, using untyped
        # Returns the value of attribute schemas.
        sig { returns(T.untyped) }
        attr_reader :schemas

        # sord omit - no YARD type given for :decorated_schemas, using untyped
        # Returns the value of attribute decorated_schemas.
        sig { returns(T.untyped) }
        attr_reader :decorated_schemas
      end
      ...
      def payload_key_type(record); end

      # sord omit - no YARD type given for "enum", using untyped
      # sord omit - no YARD type given for "path:", using untyped
      # sord omit - no YARD return type given, using untyped
      sig { params(enum: T.untyped, path: T.untyped).returns(T.untyped) }
      def decorate_enum(enum, path: nil); end

      # sord omit - no YARD type given for "record", using untyped
      # sord omit - no YARD type given for "path:", using untyped
      # sord omit - no YARD return type given, using untyped
      sig { params(record: T.untyped, path: T.untyped).returns(T.untyped) }
      def decorate_record(record, path: nil); end

      # sord omit - no YARD type given for "schema", using untyped
      # sord omit - no YARD type given for "path", using untyped
      # sord omit - no YARD return type given, using untyped
      sig { params(schema: T.untyped, path: T.untyped).returns(T.untyped) }
      def check_field_for_records(schema, path); end
