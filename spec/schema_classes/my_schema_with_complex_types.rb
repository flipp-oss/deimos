...
module Deimos
  ...
  class MySchemaWithComplexTypes < SchemaClass::Record
    ...
    # @override
    def initialize(test_id:, test_float:, test_string_array: ["test"], test_int_array: [123],
                   test_optional_int: 123, some_integer_map: {"abc"=>123},
                   some_record: Deimos::ARecord.new(:a_record_field=>"Test String"),
                   some_optional_record:, some_record_array:, some_record_map:, some_enum_array:,
                   payload_key: nil)
      super()
